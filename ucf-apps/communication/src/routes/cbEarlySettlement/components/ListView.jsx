...
class ListView extends Component {
    ...
    componentDidMount() {
        actions.communicationCbEarlySettlement.loadList(this.props.queryParam);
    ...
    getSelectedDataFunc = (selectedList, record, index) => {
        ...
        // } else {
        //     actions.communicationCbEarlySettlement.updateState({ list2: [] });
        // }
        this.setState({showFilterPopover:false});
        actions.communicationCbEarlySettlement.updateState({ list: _list, selectedList: _selectedList, formObject: _formObj, exportData:_selectedList  });

    }

    // childList = (obj) => {
    //     //加载子组件列表
    //     actions.communicationCbEarlySettlement.loadChildList(this.props.queryParam);
    // }
            ...
            <div className="grid-parent" style={{ display: this.state.listView }}>
                 ...
                 */}
                    <GridMain
                        ...
                        exportFileName="C端提前结清合同信息"　    //导出表格名称
