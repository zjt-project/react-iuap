...
export default {
    ...
    name: "communicationCbBadContract",
    /**
     * 整个model.js分为三个作用域
    ...
    effects: {
        ...
        async loadList(param = {}, getState) {
            ...
            actions.communicationCbBadContract.updateState({showLoading: true});
            ...
            actions.communicationCbBadContract.updateState(updateData); // 更新数据和查询条件
        },
        ...
        async updateRowData(param={},getState){
            ...
            let list = getState().communicationCbBadContract.list;
            ...
            actions.communicationCbBadContract.updateState({list:_list});
        },
    }
};
