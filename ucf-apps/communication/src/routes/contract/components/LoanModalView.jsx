...
class LoanModalView extends Component {
    ...
    alertDone = ()=>{
        ...
        actions.communicationContract.updateState({showLoanModal : false,list2:_list2,ifplanAdd:false});
    }


    close= () =>{
        actions.communicationContract.updateState({showLoanModal : false});
    }
