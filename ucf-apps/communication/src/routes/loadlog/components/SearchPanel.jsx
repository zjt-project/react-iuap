            ...
            },
            {
                ...
                render: (text, record, index) => {
                    if(record.type=='String'){
                        ...
                        return <Select placeholder="请选择业务类型" onChange = {this.handleChange.bind(this,index)}>
                        <Option value="合同业务">合同业务</Option>
                        <Option value="客户业务">客户业务</Option>
                        <Option value="开票业务">开票业务</Option>
                        <Option value="收支计划业务">收支计划业务</Option>
                        <Option value="付款业务">付款业务</Option>
                        <Option value="保证金收取业务">保证金收取业务</Option>
                        <Option value="保证金冲抵业务">保证金冲抵业务</Option>
                        <Option value="逾期业务">逾期业务</Option>
                        <Option value="不良合同类型">不良合同类型</Option>
                        <Option value="提前结清">提前结清</Option>
                        <Option value="收款业务">收款业务</Option>
                      </Select>
                    }
                }
            },
