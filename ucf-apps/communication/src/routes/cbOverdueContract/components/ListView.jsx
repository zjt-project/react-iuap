...
class ListView extends Component {
    ...
    componentDidMount() {
        actions.communicationCbOverdueContract.loadList(this.props.queryParam);
    ...
    getSelectedDataFunc = (selectedList, record, index) => {
        ...
        // } else {
        //     actions.communicationCbOverdueContract.updateState({ list2: [] });
        // }
        this.setState({showFilterPopover:false});
        actions.communicationCbOverdueContract.updateState({ list: _list, selectedList: _selectedList, formObject: _formObj, exportData:_selectedList });

    }

    // childList = (obj) => {
    //     //加载子组件列表
    //     actions.communicationCbOverdueContract.loadChildList(this.props.queryParam);
    // }
    ...
    grid = [
        { title: '交易批次号', key: 'paymentBatchNo', type: '0' },
        ...
        { title: '逾期状态', key: 'overdueState', type: '6' , enumType :'1000003' },
