...
export default {
    ...
    name: "communicationCbOverdueContract",
    /**
     * 整个model.js分为三个作用域
    ...
    effects: {
        ...
        async loadList(param, getState) {
            ...
            actions.communicationCbOverdueContract.updateState(updateData); // 更新数据和查询条件
        },
        ...
        async updateRowData(param={},getState){
            ...
            let list = getState().communicationCbOverdueContract.list;
            ...
            actions.communicationCbOverdueContract.updateState({list:_list});
        },
    }
};
