...
class AddFormView extends Component {
    ...
    //关闭模态框
    close = () => {
        actions.communicationWithdraw.updateState({ showModal: false });
        this.initDiv();
    };
                                        ...
                                        <Row>
                                            <Col md={4} xs={4} sm={4}>
                                                <FormItem>
                                                    ...
                                                    <FormControl
                                                        {
                                                            ...getFieldProps('paymentBatchNo', {
                                                                initialValue: formObject.paymentBatchNo,
                                                                rules: [{
                                                                    required: true,
                                                                }],
                                                            })
                                                    ...
                                                    <FormControl
                                                        {
                                                            ...getFieldProps('payeeName', {
                                                                initialValue: formObject.payeeName,
                                                                rules: [{
                                                                    required: true,
                                                                }],
                                                            })
                                            ...
                                            <Col md={4} xs={4} sm={4}>
                                                <FormItem>
                                                    ...
                                                    <FormControl
                                                        {
                                                            ...getFieldProps('receivingAccount', {
                                                                initialValue: formObject.receivingAccount,
                                                                rules: [{
                                                                    required: true,
                                                                }],
                                                            })
                                        ...
                                        <Row>
                                                    ...
                                                    <FormControl
                                                        {
                                                            ...getFieldProps('openBank', {
                                                                initialValue: formObject.openBank,
                                                                rules: [{
                                                                    required: true,
                                                                }],
                                                            })
                                                    ...
                                                    <FormControl
                                                        {
                                                            ...getFieldProps('accountNumber', {
                                                                initialValue: formObject.accountNumber,
                                                                rules: [{
                                                                    required: true,
                                                                }],
                                                            })
                                            ...
                                            <Col md={4} xs={4} sm={4}>
                                                <FormItem>
                                                    ...
                                                    <FormControl
                                                        {
                                                            ...getFieldProps('contAmount', {
                                                                initialValue: formObject.contAmount,
                                                                rules: [{
                                                                    required: true,
                                                                }],
                                                            })
                                        ...
                                        <Row>
                                            ...
                                            <Col md={4} xs={4} sm={4}>
                                                <FormItem>
                                                    ...
                                                    <FormInputNumber
                                                        ...
                                                        precision={2} //保留2位小数
                                                        {
                                                            ...getFieldProps('actualLoanAmount', {
                                                                initialValue: formObject.actualLoanAmount,
                                                                rules: [{
                                                                    required: true,
                                                                }],
                                                            })
                                            ...
                                            <Col md={4} xs={4} sm={4}>
                                                <FormItem>
                                                    ...
                                                    <FormControl
                                                        {
                                                            ...getFieldProps('paymentAccount', {
                                                                initialValue: formObject.paymentAccount,
                                                                rules: [{
                                                                    required: true,
                                                                }],
                                                            })
                                        ...
                                        <Row>
                                            <Col md={4} xs={4} sm={4}>
                                                <FormItem>
                                                    ...
                                                    <DatePicker
                                                        {
                                                            ...getFieldProps('realPayDate', {
                                                                initialValue: formObject.realPayDate,
                                                                rules: [{
                                                                    required: true,
                                                                }],
                                                            })
                                            ...
                                            <Col md={4} xs={4} sm={4}>
                                                <FormItem>
                                                    ...
                                                    <FormControl
                                                        {
                                                            ...getFieldProps('companyMainBody', {
                                                                initialValue: formObject.companyMainBody,
                                                                rules: [{
                                                                    required: true,
                                                                }],
                                                            })
